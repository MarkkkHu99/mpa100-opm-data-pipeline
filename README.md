...
This repository is an English, review-ready snapshot prepared for a Durham
University data-science dissertation. It is not vendor software and is not a
replacement for the instrument manual, laboratory SOPs or authorised maintenance.
...
release permission has not been established. See [Testing](docs/TESTING.md) and
